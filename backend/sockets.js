...
module.exports = function (io) {
  ...
  io.on('connection', async (socket) => {
    ...
    // async function dealCards(io, tableId) {
    ...
    // async function gameLoop(io, tableId) {
    ...
    //   if (!nextPlayer) {
    //     await handleDealerTurn(io, tableId);
    //     return;
    //   }
    ...
    //           (rooms[tableId].actionEnd - Date.now()) / 1000
    //         );
    ...
    // async function handleDealerTurn(io, tableId) {
    //   let room = tableId;
    //   let dealerCards = rooms[tableId].dealerCards;
    //   let visibleCards = dealerCards.visibleCards;
    //   let hiddenCards = dealerCards.hiddenCards;
    ...
    // async function processForfeitedPlayers(io, tableId) {
    ...
    // async function endRound(io, tableId) {
    //   let room = tableId;
    //   let bestDealerValue = rooms[tableId].dealerCards.bestValue;
    ...
    //   await processForfeitedPlayers(io, tableId);
