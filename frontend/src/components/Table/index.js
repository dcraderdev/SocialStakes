...
const Table = ({table, takeSeat, leaveSeat, leaveTable}) => {
  ...
  const url1 = useSelector(state=>state.users.themes.black.url)
  const url2 = useSelector(state=>state.users.themes.darkgreen.url) 
  const url3 = useSelector(state=>state.users.themes.lightgreen.url) 
  const url4 = useSelector(state=>state.users.themes.red.url) 
  const url5 = useSelector(state=>state.users.themes.realfelt.url) 
